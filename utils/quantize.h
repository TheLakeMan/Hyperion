...
/**
 * Quantize a contiguous array of FP32 weights into packed integer representation.
 *
 * @param input   Source weights in FP32 format
 * @param output  Destination buffer (caller allocates)
 * @param count   Number of weights in @p input
 * @param bits    Target bit-width (supports 4 or 8)
 */
